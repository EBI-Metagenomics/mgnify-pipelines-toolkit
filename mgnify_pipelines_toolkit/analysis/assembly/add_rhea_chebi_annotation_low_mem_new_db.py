...
def main(input: Path, proteins: Path, output: Path, rhea2chebi: Path):
    ...
    with open(input) as fh:
        for line in fh:
            ...
            top_hit = (
                "top hit" if rhea_list and protein_id not in processed_queries else ""
            )
...
if __name__ == "__main__":
    ...
    main(args.input, args.proteins, args.output, args.rhea2chebi)
