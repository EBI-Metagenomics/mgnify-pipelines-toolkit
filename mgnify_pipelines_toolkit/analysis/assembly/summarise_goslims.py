...
@click.command()
@click.option("-go", "--go_obo", required=True, type=click.Path(), help="Gene Ontology basic file.")
@click.option("-gb", "--go_banding", required=True, type=click.Path(), help="Subset GO banding file.")
@click.option("-gaf", "--gaf_input", required=True, type=click.Path(), help="GAF file, generated by generate_gaf.py")
