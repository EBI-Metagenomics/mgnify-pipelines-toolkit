...
def parse_args():
    ...
    return GO_OBO, GO_BANDING, IPS_INPUT, OUTPUT


def parse_ips_goslim_counts(ips):
    ...
    if os.path.exists(ips):
        ...
        for line in handle:
            ...
            if not current_protein_acc == previous_protein_acc:
                ...
                # count_slims(go_annotations_single_protein, map2slim_mapped_go_ids_dict,
...
def main():
    ...
    GO_OBO, GO_BANDING, IPS_INPUT, OUTPUT = parse_args()
    ...
    go_slims_2_protein_count = parse_ips_goslim_counts(IPS_INPUT)
