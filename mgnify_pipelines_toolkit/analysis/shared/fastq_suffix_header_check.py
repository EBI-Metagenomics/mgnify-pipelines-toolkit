...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Script that sanity checks whether the strand suffix of a FASTQ file matches the headers inside the FASTQ file.")
