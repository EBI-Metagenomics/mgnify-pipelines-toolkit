...
from mgnify_pipelines_toolkit.analysis.shared.proteins.parsers import ProdigalCall, parse_prodigal_header
...
def build_records_from_prodigal_faa(
    *,
    ...
    proteins_by_id, calls, total, bad = read_prodigal_faa_with_validation(prodigal_headers_faa_path, drop_terminal_stop, strict_headers)
